...
function Home() {
  return (
   ...
   <div className="card-body" >
      <FontAwesomeIcon icon={faCalendarDays } className="fas fa-calendarDays  fa-2x"/>
  ...
  <div className="col-3">
    <div className="card-body">
      <FontAwesomeIcon icon={faHospital} className="fas fa-hospital fa-2x"/>
  ...
  <div className="col-3">
    <div className="card-body">
      <FontAwesomeIcon icon={faStethoscope} className="fas fa-stethoscope fa-2x"/>
